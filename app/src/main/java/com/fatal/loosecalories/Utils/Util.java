...
public class Util {
    ...
    public static final String DOWNLOAD_PICS_DIR_NAME = "LittleFamilyRoom";
    ...
    public static boolean isArrayStrngNotNull(String[] arrayStr) {
        return arrayStr != null && arrayStr.length > 0 && isStringsNotNull(arrayStr);
    ...
    public static int getActivityDegrees(Activity activity) {
        int activityRotation = activity.getWindowManager()
                .getDefaultDisplay()
                .getRotation();
    ...
    */
     ...
     */
    public static List<ApplicationInfo> getInstalledApps(Context context, boolean excludeCurrent, boolean sort)
     ...
     * NB: To be called only in thread!
     */
    public static List<String> getInstalledPackages(Context context, boolean excludeCurrent, boolean sort)
            throws TransactionTooLargeException {
    ...
    public static String getDownloadFileSubPath(final String pFilename) {
        return DOWNLOAD_PICS_DIR_NAME + File.pathSeparator + pFilename;
    }
